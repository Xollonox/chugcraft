...
export class Player {
  ...
  get eyeY() { return this.sneaking ? PLAYER.EYE_SNEAK : PLAYER.EYE; }
   ...
   * is 60 m/s, which at a hitched 100 ms frame is six blocks in one go â€” split
  ...
  move(dx, dy, dz) {
    ...
    // Every sub-step runs, including after landing â€” bailing out early would
